...
window=tk.Tk()
window.title('輸入股票代號')
window.geometry('600x200+250+150')
...
#按鈕
button1=tk.Button(window,text='顯示本益比',font=('Arial',16),command=testing,width=10,height=2)
button2=tk.Button(window,text='折線圖收盤',font=('Arial',16),command=new_i,width=10,height=2)
button3=tk.Button(window,text='當日收盤價',font=('Arial',16),command=testing2,width=10,height=2)
button1.pack(side='left')#convert按鈕
button2.pack(side='top')#convert按鈕
button3.pack(side='right')#convert按鈕
window.mainloop()
